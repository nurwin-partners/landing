...
export const faqData: FaqSection[] = [
  {
    ...
    items: [
      {
        question: "How to become a Partner of the Nurwin Affiliate Program?",
        answer: `
				To become a partner of the Nurwin Affiliate Program, start by identifying your specific traffic sources, such as your website, social media groups, or advertisement networks. It's important to note that vague sources like "the internet" or "my friend" are unacceptable; clarity and specificity are essential.
				Once you've determined your traffic sources, visit the Nurwin Partners registration page. After registration, you must create a referral link to invite players to the casino. Remember that it's strictly prohibited for partners to register friends or family using their referral links. By following these steps, you'll be well on your way to becoming a successful partner in the Nurwin Affiliate Program! If you have further questions or need assistance, our support team is here to help.
				`,
      },
      {
        question: "How to create a referral link?",
        answer: `
				Creating a referral link in the Nurwin Affiliate Program is straightforward. First, navigate to the "Invitation Links" section by clicking on "Affiliates" and then selecting "Invitation Links" from the navigation panel. Here, you can search for existing invitation links using the provided search field, looking for affiliates by ID, name, or even by the manager who created or modified the link.
      ...
      },
      {
        ...
        answer: `
				The Partner RevShare commission is determined by the percentage of revenue generated by players you refer to the Nurwin platform. For instance, if you have a revenue share agreement of 30% and your referred players incur losses of 10,000 multiplied by 30%, which equals $3,000.
...
Choose the plan that best aligns with your goals and player engagement strategy!
      ...
      {
        question:
          "What are the time limits within which invited players bring revenue?",
        answer: `
...
The quality of these materials is very high, and we continuously add new graphic and text resources to make your advertising efforts more effective. To stay updated on the latest promotional materials, be sure to follow the news section of the Bons Affiliate Program. This section will also inform you about upcoming events, promotions, significant tournaments, and other initiatives to attract new players and help you maximize your earnings. 
      ...
      {
        question: `How can I become a successful webmaster with Nurwin?`,
        answer: `
				Being a webmaster can be challenging today, but it's also a lucrative opportunity. You must take the initiative to achieve success and maximize your earnings with the Nurwin Affiliate Program. Start by creating your website and focus on its ongoing development. Explore various advertising options to enhance your profitability. The Nurwin Affiliate Program offers unique chances to earn money by inviting gambling players, so take advantage of this potential. Remember, we're here to provide support and assistance whenever needed.
				`,
      },
      {
        question: `How can I get support at Nurwin?`,
        answer: `
				You can get support at Nurwin through two main channels: 
Visit our support page at https://nurwin.com/support, where you'll find helpful resources and answers to common questions.
You can also email our support team at partner.support@nurwin.com. We offer 24/7 support to assist you with any inquiries or issues.
Don't hesitate to contact us – we're here to help!
				`,
      },
      {
        question: `Is Nurwin a safe site?`,
        answer: `
				Yes, Nurwin is a safe and secure online gaming destination. Established in 2023, we are a fully licensed platform dedicated to providing excitement and entertainment at your fingertips. With an impressive library featuring over 9,000 games and slots, we cater to various tastes and preferences. Our commitment to safety includes robust security measures to protect your personal information and ensure a fair gaming experience. Play with confidence, knowing that your gaming experience is our top priority!
				`,
      },
    ],
  },
...
You can generate reports based on individual trackers, currencies, or players for a more granular view. Before generating the report, enable grouping by the desired parameter. You can add or remove options as needed.
      ...
      {
        question: "How much can I earn with the Nurwin Affiliate Program?",
        answer: `
Your earnings with the Nurwin Affiliate Program primarily depend on the number of players you refer to and the total profits those players generate for the platform you are promoting. The more active and profitable players you bring in, the higher your commission will be.
				`,
      },
      {
        question:
          "How can I withdraw my earnings from the Nurwin Affiliate Program?",
        answer: `
...
We are committed to ensuring your satisfaction, so feel free to reach out if you have any questions or require assistance with the withdrawal process. Your journey to financial success starts here!
      ...
      },
      {
        ...
        answer: `
You can withdraw your earnings up to twice a month unless other arrangements have been made. At Nurwin, we pride ourselves on our flexibility and are always willing to work with our partners to accommodate individual needs. Don't hesitate to reach out if you have specific requirements or require adjustments! We're here to support you on your journey to success. 
				`,
      },
      {
        question: "How can I apply for CPA programs?",
        answer: `
To apply for our CPA programs, simply reach out to the managers of the Nurwin Affiliate Program and share relevant details about your traffic sources. Our experienced team will review your information and present you with suitable CPA plans tailored to your qualifications. We look forward to collaborating with you and helping you succeed!
				`,
      },
    ],
  },
...
By keeping track of these indicators, you can gain valuable insights into your performance and optimize your strategies accordingly. If you have any questions or need further clarification on any of these metrics, feel free to reach out!
      ...
      },
      {
        ...
        answer: `
The Nurwin Affiliate Program is dedicated to continuously enhancing our promotional materials to empower our partners and maximize their traffic efficiency. Currently, you can access a variety of resources, including:
